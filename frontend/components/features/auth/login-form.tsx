  ...
  return (
    <div className={cn("w-full space-y-10", className)} {...props}>
      ...
      <div className="space-y-6">
        ...
        {!showEmailForm ? (
          ...
          <div className="animate-in fade-in duration-300">
            ...
            <h1 className="text-3xl font-black text-white tracking-tight">Sign in with email</h1>
          </div>
        )}
      </div>
      ...
      {!showEmailForm ? (
        <div className="space-y-4 animate-in fade-in duration-300">
          ...
          >
            ...
            <div className="flex-1 text-left">
              ...
              <p className="text-[11px] text-white/35 mt-0.5">Sign in with your Google account</p>
            </div>
          ...
          >
            ...
            <div className="flex-1 text-left">
              ...
              <p className="text-[11px] text-white/35 mt-0.5">Sign in using your email and password</p>
            </div>
            <ArrowRight className="w-4 h-4 text-white/20 group-hover:text-[#f2aa4c]/60 group-hover:translate-x-0.5 transition-all duration-200" />
          </button>
        ...
        <form onSubmit={handleLogin} className="space-y-8 animate-in fade-in slide-in-from-right-2 duration-300">

          <div className="space-y-6">
            <div className="space-y-2 group">
              <Label htmlFor="login-email" className="text-[10px] uppercase tracking-[0.2em] text-white/35 font-black">
                Email address
              </Label>
            ...
            <div className="space-y-2">
              <div className="flex items-center justify-between">
                <Label htmlFor="login-password" className="text-[10px] uppercase tracking-[0.2em] text-white/35 font-black">
                  Password
                </Label>
                <Link href="/auth/forgot-password" className="text-[10px] text-[#f2aa4c]/60 hover:text-[#f2aa4c] transition-colors font-semibold">
                  Forgot?
                </Link>
              </div>
              <Input
      ...
      <p className="text-sm text-white/30 text-center pt-4 border-t border-white/[0.05]">
        No account?{" "}
        <Link 
          href={showEmailForm ? "/auth/sign-up?mode=email" : "/auth/sign-up"} 
